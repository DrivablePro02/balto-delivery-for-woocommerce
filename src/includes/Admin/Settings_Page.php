...
class Settings_Page {
    ...
    private function __construct() {
        ...
        add_action('wp_ajax_save_balto_settings', [$this, 'save_settings']);
    ...
    public function register_settings(): void {
        register_setting(
            ...
            [
                ...
                'sanitize_callback' => [$this->settings, 'sanitize_balto_settings']
            ]
        );
    ...
    public function save_settings(): void {
        ...
        $settings = $_POST[$this->settings::OPTION_NAME] ?? [];
        ...
        $checkbox_fields = ['enable_tracking'];
        foreach ($checkbox_fields as $field) {
            $settings['general'][$field] = $settings['general'][$field] ?? 'no';
        }
    
        // Handle dropdown fields
        $dropdown_fields = ['selected_shipping_provider'];
